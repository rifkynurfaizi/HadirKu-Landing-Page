  ...
  <body class="home-three">
    <div class="main-wrapper">
                  ...
                  <div class="post-left">
                    <ul>
                        ...
                        <div class="post-author">
                          <a href="instructor-profile.html"
                            ><img
                              ...
                              alt="Post Author"
                            />
                            <span class="quattrocento-sans-regular"
                              >Ruby Perrin</span
                            ></a
                          >
                        </div>
                      ...
                      <li>
                        <img
                          class="img-fluid"
                          src="assets/img/icon/icon-22 1.svg"
                          alt
                        />April 20, 2022
                      </li>
                      <li>
      ...
      <footer class="footer footer-three">
        <div class="footer-three-top" data-aos="xfade-up">
          <div class="container">
        ...
        <div class="footer-three-bottom" data-aos="xfade-up">
          <div class="container">
